...
And it stays positive disregard any implementation of the `person.partner` method you would do. This is exactly how your app expects `Person` class to behave. So why your tests should be different and expect something from class while relying on its internal implementation?
